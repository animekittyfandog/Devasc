...
if ($page > $total_pages) {
    header("Location: violation.php?page=" . $total_pages);
    exit;
}
if ($page < 1) $page = 1;
...
<div id="confirm-modal" class="modal-overlay">
    <div class="modal-content">
        ...
        <p>Are you sure you want to confirm this violation? This will move it to the archive.</p>
...
<div id="delete-modal" class="modal-overlay">
    <div class="modal-content">
        ...
        <p>Are you sure you want to delete this violation record? This will also move it to the archive.</p>
        <div class="modal-buttons">
